...
function createSelectedProductsContent(image, name, price, discount, Fabric, time) {
    ...
    newStrong[4].textContent = 'Fabric Quality: ';
    ...
    newQuantitySpan.innerHTML = 'Piece';
    ...
    let FabricSpan = document.createElement('span');
    FabricSpan.textContent = Fabric;

    let timeSpan = document.createElement('span');
    timeSpan.textContent = time;

    newPara[4].appendChild(FabricSpan);
...
function addItemsToSelectedProducts(productIndex) {
    ...
    newCartContent[productIndex] = createSelectedProductsContent(productCartImage, productCartName, productCartPrice, productCartDiscount, FabricName, addedTime);
